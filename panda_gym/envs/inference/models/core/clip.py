...
def build_model(state_dict: dict):
    ...
    #    for s in ["input_resolution", "context_length", "vocab_size"]:
    #        if s in k:
    #            del state_dict[k]
    #            print(k)

    state_dict = {k:state_dict[k] for k in state_dict.keys() if not 'input_resolution' in k}
    state_dict = {k:state_dict[k] for k in state_dict.keys() if not 'context_length' in k}
    state_dict = {k:state_dict[k] for k in state_dict.keys() if not 'vocab_size' in k}
